...
class ProductLine
{
    ...
    fileprivate class func iDevices() -> ProductLine {
        ...
        products.append(Product(titled: "Apple watch 2", description: "Apple Watch Series 2 has built-in GPS, a fast dual-core processor, and is rated water resistant 50 meters. It's designed for all the ways you move.", imageName: "apple-watch.tif"))
